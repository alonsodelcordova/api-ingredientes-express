...
export const registrarUsuarioController = async (req: Request, res: any, next:NextFunction) => {
    try {
...
export const iniciarSesion = async (req: Request, res: any, next: NextFunction) => {
    try {
        const userDto: CreateUsuarioDto = req.body
